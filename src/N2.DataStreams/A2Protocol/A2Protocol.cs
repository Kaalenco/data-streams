...
{
    public static HttpStatusCode SendFile(
        Uri uri, 
        string filename, 
        byte[] fileData, 
        string from, 
        ...
        string recipientCertFilename)
    {
        ...
        if (encrypt)
        {
            ...
            byte[] contentWithContentTypeHeaderAdded = AS2Utilities.ConcatBytes(signedContentTypeHeader, content);
